...
## **DAY 1｜Meet Your Builders：认识彼此，找到互补搭子**
...
好的组队不是“谁和我兴趣一样”，而是“谁能和我一起把事情做出来”。

每位同学准备一份 60 秒自我介绍：

-   我是谁，我选择的方向是什么？
    
-   Week 2 我完成了什么 Proof of Work？
...
-   Week 2 Portfolio Pack 与 Role Statement。
    
-   GitHub Issues / Projects：[https://docs.github.com/issues](https://docs.github.com/issues)
    
-   Notion Projects & Tasks：[https://www.notion.so/help/guides/category/projects](https://www.notion.so/help/guides/category/projects)
    
-   Monad Developer Portal：[https://developers.monad.xyz/](https://developers.monad.xyz/)
    
-   Monad Ecosystem：[https://www.monad.xyz/ecosystem](https://www.monad.xyz/ecosystem)
    

### **🛠 今日任务**

-   Builder Profile Card：整理个人方向、技能、Proof of Work、兴趣、时间投入和队友需求。
    
-   Idea Pitch：用一句话说明“为谁解决什么问题，以及准备做什么”。
    
-   Team Formation Card：建立 2–5 人小队，写清成员、角色、联系方式、共同目标和协作工具。
    
-   Team Working Agreement：约定每日同步时间、任务看板、决策方式、缺席处理和安全边界。
